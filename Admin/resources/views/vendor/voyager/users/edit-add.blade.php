                    ...
                    {{-- <div class="panel"> --}}
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="artisticName" name="artisticName" placeholder="Artistic Name"
                                       value="@if(isset($dataTypeContent->artisticName)){{ $dataTypeContent->artisticName }}@endif">
                            </div>
