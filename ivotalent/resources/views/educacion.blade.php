  ...
  <div data-page="blog" class="page no-toolbar no-navbar">
    ...
    <a href="#" data-panel="right" class="open-panel">
     ...
     <div id="pages_maincontent">
      <h2 class="page_title" style="color: #f7941e; !important;"><b>EDUCACIÓN</b> - {{strtoupper($currentuser->name) }}<a  href="#" data-popup=".popup-educacion" class="open-popup"><i class="fas fa-plus-circle"  style="margin-left: 2em"></i></a></h2>
     <div class="page_single layout_fullwidth_padding">  
            ...
            <div class="list-block">
              ...
              @foreach ($currentEducacion as $ed)
              <form method="post" id="frmEliminarEd{{$ed->id}}" action="{{ route('eliminareducacion', ['id' => $ed->id]) }}">
            {{csrf_field()}}
                  ...
                  <div class="swipeout-content item-content">
                    <div class="post_entry">
                      ...
                      <div class="post_category">
                          ...
                          <h4><a href="#">{{$ed->Institucion}}</a></h4>
                          <h4><a href="#">{{$ed->Desde}}</a></h4>   
                          <h4><a href="#">{{$ed->Disciplina}}</a></h4>  
