  ...
  <div data-page="blog" class="page no-toolbar no-navbar">
    ...
    <a href="#" data-panel="left" class="open-panel">
     ...
     <div id="pages_maincontent">
      <h2 class="page_title" style="color: #f7941e; !important;"><b>RECONOCIMIENTOS</b> - {{strtoupper($currentuser->name) }}<a  href="#" data-popup=".popup-reconocimientos" class="open-popup"><i class="fas fa-plus-circle"  style="margin-left: 2em"></i></a></h2>
     <div class="page_single layout_fullwidth_padding">  
   
            <div class="list-block">
              <ul class="posts">

              @foreach ($currentReconocmientos as $ed)
                 <form method="post" id="frmEliminarRec{{$ed->id}}" action="{{ route('eliminarreconocimiento', ['id' => $ed->id]) }}">
            {{csrf_field()}}
                  ...
                  <div class="swipeout-content item-content">
                    <div class="post_entry">
                     ...
                     <div class="post_category">
                          ...
                          <h5><a href="#"> {{str_limit($ed->Texto , $limit = 100, $end = '...') }}</a></h5>
                          </div>
                        </div>
